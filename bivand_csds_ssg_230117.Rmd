...
- The plan is to retire **maptools**, **rgdal** and **rgeos** during 2023
...
- Within three weeks and over the holiday period, activity was observed for 32\% of the packages (31\% of those using retiring packages in code)

- 42\% of the github issues showed activity, but only 11\% of the emails elicited any response
